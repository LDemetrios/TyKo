...
public interface TDynamic : TValue, DynamicEnum, TSetBibliography, TBibliography, TSetList, TList,
        ...
        TLength, TRatio, TRelativeImpl, TFraction, TColor, TGradientGradient, TLuma, TOklab, TOklch,
        TLinearRgb, TRgb, TCmyk, THsl, THsv, TLinearGradient, TRadialGradient, TConicGradient, TTiling,
        TVersion, TLabel, TDatetime, TDuration, TType, TModule, TPlugin, TAlignmentImpl, TDirection,
        TRegex, TMathAlignPoint, TStroke, TSelector, TElementSelector, TLabelSelector, TRegexSelector,
